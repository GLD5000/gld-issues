...
export default function GitIssueCard({
  ...
  const [fullBody, setFullBody] = useState(issue.body);
  ...
  return (
    <div className="relative w-full">
      <div className="mr-6 md:mr-0 flex flex-wrap lg:grid lg:grid-cols-[auto_1fr_auto_40px] items-center w-[calc(100%-26px)] lg:w-full box-border bg-neutral-100 dark:bg-neutral-900">
