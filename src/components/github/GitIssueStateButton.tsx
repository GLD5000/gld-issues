...
export default function GitIssueStateButton({
    ...
    return (
        <select
            ...
            className={`block cursor-pointer p-1 box-border w-36 h-[30px] text-center rounded-none border-none text-black ${progressState.bg || 'bg-black'} hover:bg-white focus:bg-white`}
...
function getProgressState(issue: SelectiveIssue) {
    ...
    const isDueSoon =
        issueDeadlineWeek === currentWeek ||
        issueDeadlineWeek === currentWeek + 1;
