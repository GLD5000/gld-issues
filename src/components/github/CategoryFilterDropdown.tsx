...
export default function CategoryFilterDropdown({
    ...
    return (
        <select
            ...
            className={`block text-sm cursor-pointer p-1 box-border w-36 h-fit text-left border-2 rounded-none bg-neutral-100 border-black text-black text-ellipsis ${currentValue === 'Select Category' ? 'text-neutral-400' : 'text-black'} font-Avenir-medium`}
            value={currentValue}
