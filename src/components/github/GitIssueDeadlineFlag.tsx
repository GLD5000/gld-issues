...
export default function GitIssueDeadlineFlag({
    ...
    return (
        <div
            className={`grid relative cursor-default p-1 box-border w-36 h-6 my-auto text-center rounded-none items-center text-black dark:text-white items-center border-2 border-solid ${progressState.border || 'border-black dark-border-white'}`}
        >
